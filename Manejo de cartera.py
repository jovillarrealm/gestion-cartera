...
def read_excel_file(report_path, client):
    ...
    for i in data:
        if i[3] > 0:
            if i[0] < 21:
                ...
                server.sendmail("observatorioproyecto1@gmail.com", i[4], message)
                server.quit()
    ...
    server.login("observatorioproyecto1@gmail.com", "uwftzgqywensvpdm")
    server.sendmail(
        "observatorioproyecto1@gmail.com", "jorgealfredo201386@gmail.com", message
    )
    server.quit()
...
if __name__ == "__main__":
    ...
    if name is not None:
        ...
        if validate_report(repath):
            ...
            # Related to Twilio
            account_sid = "ACfb030fb0f1c35c410acc044a1ef9ea3f"
            auth_token = "c9fde0f89d037c22abfa46406c88b872"
